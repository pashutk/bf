...
// Input two chars to toggle the cell (live/dead) and hit enter to change state of the given cell
// Press enter to tick
export const gameOfLife = `[life.b -- John Horton Conway's Game of Life
